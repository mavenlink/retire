  ...
  class CountTest < Test::Unit::TestCase
    ...
    context "Count" do
      ...
      should "count all documents by the leaving index empty" do
        ...
        assert_match %r|elasticsearch\.mavenlink\.link:32429/_count|, c.url
      end
      ...
      should "return curl snippet for debugging" do
        ...
        assert_match %r|curl \-X GET 'http://elasticsearch\.mavenlink\.link:32429/index/_count\?pretty' -d |, c.to_curl
